...
import { ChevronRight, Users, FileText, Calendar, Bell, Building2, BarChart2, Shield, Settings, Briefcase, UserCheck } from 'lucide-react'
...
const CARDS = [
  ...
  { label: 'Contratos',              desc: 'Gestión de contratos laborales',             icon: Briefcase, color: '#B45309', to: '/contratos',      badge: undefined },
...
export function DashboardPage() {
  ...
  return (
    <div className="bg-gray-100 flex-1 px-6 py-8 space-y-6">

      {/* Saludo */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900">
          Hola, <span style={{ color: '#7C3AED' }}>{user?.firstName}.</span>
        </h1>
      ...
      <div className="bg-white rounded-2xl p-4 border border-gray-100 shadow-sm">
        ...
        <div className="grid grid-cols-3 gap-2 text-center">
          <div>
            ...
            <p className="text-xs text-gray-400 leading-tight">Empleados activos</p>
          </div>
          <div>
            <p className="text-2xl font-bold text-gray-900">5</p>
            <p className="text-xs text-gray-400 leading-tight">Documentos pendientes</p>
          </div>
          <div>
